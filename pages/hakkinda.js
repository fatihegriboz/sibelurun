...
function About() {
  return (
    <>
      <Head>
        <title>Sibel Ürün hakkında | {SiteConfig.title}</title>
      </Head>
      <PageTransition>
        <Layout>
          <Container>
              ...
              <div className="grid sm:grid-cols-2 gap-20">
                <div>
                  <p className="pt-6">
                    ...
                    , Bursa Anadolu Lisesi’nde Lise öğrenimini aldıktan sonra
                    1996 yılında Bilkent Üniversitesi Güzel Sanatlar Fakültesi
                    İç Mimarlık ve Çevre Tasarımı lisansını tamamladı.
                  ...
                  <p className="pt-6">
                    ...
                    şirketini kurdu ve aynı firma adı altında faaliyetlerine
                    devam etmektedir.
                  </p>
                  <p className="pt-6">
                    <strong>
                    ...
                    yönelik bir çok projenin tamamlanmasını sağladı. Halen
                    kişisel ve kurumsal mimari çözümler oluşturmakta,
                    faaliyetlerini İstanbul ve Las Vegas mimari ofislerinde
                    projelerin hayata geçmesi üzerine devam ettirmektedir.
                  </p>
                  <p className="pt-6">
                    <strong>
                      “Kapıdan girdiğimde hayaller kurarım. Kurduğum hayallerim
                      tasarımlarıma yön verir. Tasarımlarım ise yaşam tarzlarına
                      ışık tutar. Her müşteri ise yeni bir kimliktir benim için
                      ve mekanların bu kimliklerle uyumlu olmasına özen
                      gösteririm.“
                    </strong>
